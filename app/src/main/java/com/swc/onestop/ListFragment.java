...
import static com.swc.onestop.FindFragment.paperdetails;
...
//        }
    ...
    public void downloadFile(Uri u, String filename) {
        ...
        DownloadManager manager = (DownloadManager) (new Activity()).getSystemService(DOWNLOAD_SERVICE);
