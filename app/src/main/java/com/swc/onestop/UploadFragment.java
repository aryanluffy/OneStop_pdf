...
import static com.swc.onestop.HomeActivity.isathome;
...
import static com.swc.onestop.HomeActivity.uploadname;
import static com.swc.onestop.HomeActivity.uploadurl;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        uploadpdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(inputdisplaytext.getText().toString().equals("No File Selected")){
...
//            mapper.put("uploaderID", FirebaseAuth.getInstance().getCurrentUser().getUid());
            mapper.put("uploaderID","KAITOU_KID");
